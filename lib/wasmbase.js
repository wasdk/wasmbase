...
function getInstance(url, imports, options) {
  return fetchModule(url).then(function (module) {
...
var wasmPath = require.resolve('./wasmbase.wasm');
exports.ready = fetchModule(wasmPath).then(function (module) {
  return initNativeBase(module);
});
